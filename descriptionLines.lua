...
return {
    ...
    [types.requirementType.NotActorID] = { str = "The actor is#negNotContr# @variableObj.name@", priority = -1001 },
    ...
    [types.requirementType.CustomActorClass] = { str = "The NPC's class is #operator# @tes3.findClass(value) and tes3.findClass(value).name or value@", priority = -1001 },
    ...
    [types.requirementType.NotActorFaction] = { str = "The NPC's faction is#negNotContr# #operator# @variableObj.name@", priority = -1001 },
    ...
    [types.requirementType.NotActorCell] = { str = "@objectObj and objectObj.name or \"The actor\"@ is#negNotContr# in @variableObj and variableObj.name or \"???\"@", },
