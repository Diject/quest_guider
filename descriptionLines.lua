...
return {
    ...
    [types.requirementType.CustomPCFaction] = { str = "The player in #factionValue# faction", },
    ...
    [types.requirementType.NotActorFaction] = { str = "The NPC's faction is#negNotContr# #operator# #factionVar#", priority = -1001 },
