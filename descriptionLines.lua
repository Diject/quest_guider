...
return {
    ...
    [types.requirementType.CustomSpell] = { str = "#objNameOrTheActor# has#notContr# \"#varName#\" spell", priority = -1001 },
    ...
    [types.requirementType.CustomEffect] = { str = "#magicEffect# effect is#notContr# affecting #objNameOrTheActor#", priority = -1001 },
    ...
    [types.requirementType.CustomOnDeath] = { str = "#objNameOrTheActor# is#notContr# killed", priority = -1001 },
    [types.requirementType.CustomOnPCHitMe] = { str = "The actor is#notContr# alarmed by a crime", priority = -1001 },
    [types.requirementType.CustomTarget] = { str = "#varName# is#notContr# in focus for #objNameOrTheActor#", priority = -1001 },
    [types.requirementType.NotActorClass] = { str = "The NPC's class is#notContr# #classVar#", priority = -1001 },
    [types.requirementType.CustomCommonDisease] = { str = "#objNameOrTheActor# is#notContr# sick with a common disease", priority = -1001 },
    ...
    [types.requirementType.CustomSayDone] = { str = "#objNameOrTheActor# is#negNotContr# saying anything", priority = -1001 },
    [types.requirementType.NotActorCell] = { str = "#objNameOrTheActor# is#negNotContr# in #varName#", },
    [types.requirementType.CustomHasItemEquipped] = { str = "#objNameOrTheActor# has#notContr# #varName# item equipped", priority = -1001 },
    [types.requirementType.CustomHealth] = { str = "Health of #objNameOrTheActor# is #operator# #value#", priority = -1001 },
    ...
    [types.requirementType.CustomSpellReadied] = { str = "A spell is#notContr# readied for #objNameOrTheActor#", },
    ...
    [types.requirementType.NPCHealthPercent] = { str = " #objNameOrTheActor#'s health fraction is #operator# #value#", },
    [types.requirementType.CustomHitOnMe] = { str = " #objNameOrTheActor# was hit by \"#varName#\"", },
}