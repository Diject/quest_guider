...
return {
    ...
    tracking = {
        ...
        localMarker = { path = "diject\\quest guider\\skyrimMarker16x32.dds", pathAbove = "diject\\quest guider\\skyrimMarker16x32.dds",
            pathBelow = "diject\\quest guider\\skyrimMarker16x32.dds", shiftX = -4, shiftY = 15, scale = 0.5 },

        ---@type questGuider.tracking.markerImage
        doorMarker = { path = "diject\\quest guider\\skyrimDoorMarker16x32.dds", pathAbove = "diject\\quest guider\\skyrimDoorMarkerUp32x32.dds",
            pathBelow = "diject\\quest guider\\skyrimDoorMarkerDown32x32.dds", shiftX = -4, shiftY = 15, scale = 0.5 },

        ---@type questGuider.tracking.markerImage
        worldMarker = { path = "diject\\quest guider\\skyrimMarker16x32.dds", pathAbove = "diject\\quest guider\\skyrimMarker16x32.dds",
            pathBelow = "diject\\quest guider\\skyrimMarker16x32.dds", shiftX = -4, shiftY = 15, scale = 0.5 },

        ---@type questGuider.tracking.markerImage
        questGiverMarker = { path = "diject\\quest guider\\skyrimExclamationMark8x16.dds", shiftX = -3, shiftY = 10, scale = 0.75 },
    },
}